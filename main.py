...
from config import CACHE_FILE, robot_step_distance_global, USE_ROAD_NUMBERS
...
def main():
    ...
    road_graph = load_or_cache_road_data(cache_file)
    ...
    particles_list = initialize_particles(enhanced_graph, 500,distance_cache)
